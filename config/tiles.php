...
$tile[] = array("type"=>"img","group"=>2,"x"=>2,"y"=>2,'width'=>1,'height'=>1,"background"=>"#180052","url"=>"lap-statistik-obat.php",
	"img"=>"img/icons/lap-resep.png","desc"=>"Analisa Probabilitas","showDescAlways"=>true,"imgWidth"=>1,"imgHeight"=>1,
	"labelText"=>"","labelColor"=>"#000","labelPosition"=>"","classes"=>"");

$tile[] = array("type"=>"img","group"=>2,"x"=>3,"y"=>0,'width'=>1,'height'=>1,"background"=>"#180052","url"=>"lap-analisis-abc.php",
