...
function form_add() {
    ...
    $('#form_pemesanan').dialog({
        ...
        buttons: {
            ...
            $.ajax({
                url: 'pages/pemesanan-edit.php',
                cache: false,
                success: function(msg) {
                    $('#pesanan-list tbody').html(msg);
                }
            });
        }
    });
    $('#save_pemesanan').submit(function() {
        ...
        $.ajax({
            url: 'models/update-transaksi.php?method=save_rencana_pemesanan',
            data: $(this).serialize(),
            dataType: 'json',
            type: 'POST',
            success: function(data) {
...
function load_data_pemesanan(page, search, id) {
    ...
    $.ajax({
        url: 'pages/pemesanan-plant-list.php',
        cache: false,
        data: 'page='+pg+'&search='+src+'&id_pemesanan_plant='+id_barg,
        success: function(data) {
...
<h1 class="margin-t-0">Rencana Pemesanan</h1>
<hr>
